document.addEventListener("DOMContentLoaded", () => {
    ...
    const cardioAdvice = {
        "Excellent": { title: "ELITE CARDIO", text: "Outstanding! Your heart recovers very quickly, indicating a strong, highly efficient cardiovascular system. Keep up your current training routine!", color: "#00C851" },
        "Good": { title: "HEALTHY CARDIO", text: "Great job. Your heart rate recovery is in a very healthy range. To push to the next level, consider adding one High-Intensity Interval Training (HIIT) session per week.", color: "#33b5e5" },
        "Average": { title: "AVERAGE CARDIO", text: "You are right in the middle! To improve your heart's efficiency, try incorporating 30 minutes of steady-state cardio (like brisk walking, cycling, or swimming) 3-4 times a week.", color: "#ffbb33" },
        "Below Average": { title: "ROOM FOR IMPROVEMENT", text: "Your heart is working a bit harder to recover. Focus on steady, low-impact movement. Start with 15-20 minutes of light walking daily and slowly build up your stamina over the next month.", color: "#ff4444" },
        "Invalid": { title: "INVALID DATA", text: "Your post-exercise heart rate cannot be lower than or equal to your resting heart rate. Please delete this record and enter accurate data.", color: "#888888" }
    };
